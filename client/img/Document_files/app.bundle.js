...
var _CoinList = __webpack_require__(23);

var _CoinList2 = _interopRequireDefault(_CoinList);

var _ListLoading = __webpack_require__(55);
...
var _NewsSlider = __webpack_require__(57);
...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.state = {
			images: ['./client/img/bitcoinforks.jpg', './client/img/Ethereum.jpg', './client/img/Litecoin.jpg', './client/img/Neo.jpg']
		};
		return _this;
	}
	...
	_createClass(App, [{
		...
		value: function refresh() {
			var that = this;
			axios.get('/getCoins').then(function (response) {
				that.setState({
					coins: response.data
				});
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(_NewsSlider2.default, { images: this.state.images }),
				React.createElement(
					'div',
					null,
					'Total'
				...
				React.createElement(
					...
					React.createElement(
						'thead',
						{ className: 'coinlist__header', align: 'left' },
						React.createElement(
							'tr',
							null,
							React.createElement(
					...
					this.state.coins ? React.createElement(_CoinList2.default, { coins: this.state.coins }) : React.createElement(_ListLoading2.default, null)
				)
			);
		}
	}]);
...
var _Coin = __webpack_require__(24);
...
var CoinList = function (_React$Component) {
	_inherits(CoinList, _React$Component);

	function CoinList(props) {
		_classCallCheck(this, CoinList);

		var _this = _possibleConstructorReturn(this, (CoinList.__proto__ || Object.getPrototypeOf(CoinList)).call(this, props));
	...
	_createClass(CoinList, [{
		...
		value: function render() {
			return React.createElement(
				'tbody',
				{ className: 'coinlist__body' },
				this.props.coins.map(function (coin, index) {
					return React.createElement(_Coin2.default, { coin: coin, key: index });
				})
			);
		}
	}]);
	...
	_createClass(Coin, [{
		...
		value: function render() {
			return _react2.default.createElement(
				"tr",
				{ className: "coinlist__coin" },
				_react2.default.createElement(
					"td",
					{ className: "coinlist__coindetail" },
				...
				_react2.default.createElement(
					...
					{ className: "coinlist__coindetail" },
					" $",
					parseFloat(this.props.coin.price_usd).toFixed(2)
				),
				_react2.default.createElement(
					"td",
					{ className: "coinlist__coindetail" },
				...
				_react2.default.createElement(
					"td",
					{ className: "coinlist__coindetail " + (this.props.coin.percent_change_24h >= 0 ? 'positive' : 'negative') },
...
var ListLoading = function (_React$Component) {
	_inherits(ListLoading, _React$Component);

	function ListLoading(props) {
		_classCallCheck(this, ListLoading);

		var _this = _possibleConstructorReturn(this, (ListLoading.__proto__ || Object.getPrototypeOf(ListLoading)).call(this, props));

		_this.state = {};
		return _this;
	}

	_createClass(ListLoading, [{
		key: "render",
		value: function render() {
			return (
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"td",
							{ colSpan: "4" },
							_react2.default.createElement("div", { className: "loading__img" })
						)
					)
				)
			);
	...
	_createClass(Navigation, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"span",
					{ className: "navigation__directory" },
					_react2.default.createElement(
						"a",
						{ href: "#", className: "navigation__login" },
						" Login "
					),
					_react2.default.createElement(
						"span",
					...
					_react2.default.createElement(
						"a",
						{ href: "#", className: "navigation__register" },
						" Register "
					)
				)
			);
...
var NewsSlider = function (_React$Component) {
	_inherits(NewsSlider, _React$Component);

	function NewsSlider(props) {
		_classCallCheck(this, NewsSlider);

		var _this = _possibleConstructorReturn(this, (NewsSlider.__proto__ || Object.getPrototypeOf(NewsSlider)).call(this, props));
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'slideshow--index' },
						this.state.slide + 1,
						'/',
						this.props.images.length
					),
					_react2.default.createElement('img', { className: 'slideshow--img', src: this.props.images[this.state.slide] })
				),
				_react2.default.createElement(
					'div',
					{ className: 'slideshow__slide' },
					...
					_react2.default.createElement('img', { className: 'slideshow--img', src: this.props.images[this.state.slide + 1] })
				),
				_react2.default.createElement(
					'button',
					{ className: 'slideshow__prev', value: 'prev', onClick: this.changeSlide.bind(this) },
					' < '
				),
				_react2.default.createElement(
					'button',
					{ className: 'slideshow__next', value: 'next', onClick: this.changeSlide.bind(this) },
					' > '
				)
			);
		}
	...
	_createClass(News, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement("img", { className: "slideshow--img", src: this.props.image })
			);
		}
	}]);
